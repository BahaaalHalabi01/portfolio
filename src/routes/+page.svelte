...
<section class="flex gap-y-4 flex-col min-h-full" id="about">
	...
	<div class="py-6" />
	<button class="text-xl w-fit border-green-600 border-2 p-2">Interested in More?</button>
</section>
<div class="py-24" />
<section class="flex gap-y-10 flex-col" id="experience">
	<h1 class="text-green-600 lg:text-6xl">My Experience</h1>
	...
	<ExperienceAccordion label={titles[0]} website="bedu.me" href="https://bedu.me">
		...
		<p class="text-xl">
			...
			validate them, and implement them. It gave me big confidence to know that i understand what i
			am doing, and that i can take decisions that will help the product move forward and perform
			much better.
		</p>
		<p class="text-xl">A summary of tasks i did:</p>
		<ul class="list-disc list-inside">
			<li>
				Rewrite entire frontend (UI/UX and api layer) which was using material-ui,redux toolkit, and
				NextJs 12 to use NextJs 13 ( add SSR and ISR ), TailwindCSS, and use context api with
				tanstack-query for the api layer. This vastly improved the performance and responsiveness of
				the system.
			</li>
			<li>
			...
			<li>
				...
				if needed (usually done through pair programming), and code review upon finishing the task.
			</li>
		</ul>
	...
	>
		...
		<p class="text-xl">
			...
			on things that i didn't know, nor even had the intention of learning (ex: kubernetes). It was
			the first time i was challanged with real world problems after doing many straight-forward
			tasks/youtube tutorials.
		</p>
		<p class="text-xl">A summary of tasks i did:</p>
		<ul class="list-disc list-inside">
			<li>
